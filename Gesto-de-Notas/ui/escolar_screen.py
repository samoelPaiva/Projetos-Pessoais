...
from logic.escola_logic import status_escolar, objetivo_ou_final
from ui.splash_screen import show_transition
from tkinter import messagebox

def criar_tela_escolar(janela, COLORS, app_manager):
    ...
    tk.Label(
        header,
        text="Planeje, cadastre e gerencie suas notas escolares",
        bg=COLORS['card_bg'],
